	...
	<div class="container">
		<ul class="nav nav-tabs">
			...
			<li class="nav-item"><a
				...
				href="AdminDispatcher/toAddArea">新增区域</a></li>
		</ul>
			...
			<tbody>
				<c:forEach items="${areaList }" var="area">
					<tr>
						...
						<th scope="col">${area.areaName }</th>
						<th scope="col">${area.userId }</th>

						<th scope="col"><a class="btn btn-outline-warning"
							href="AdminDispatcher/toAreaUpdate?areaId=${area.id }">修改</a> <a
							class="btn btn-outline-danger"
							href="AdminDispatcher/areaDelete?areaId=${area.id }"
